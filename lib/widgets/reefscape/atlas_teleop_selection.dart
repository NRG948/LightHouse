          ...
          Column(
            children: [
              ...
              Counter(
                ...
                onIncrement: () => {history.addLast("algaeScoreNet")},
              ),
              Counter(
                ...
                color: Constants.pastelGreen,
                boxColor: Constants.pastelWhite,
                onIncrement: () => {history.addLast("algaeScoreProcessor")},
              ),
              Counter(
                ...
                color: Constants.pastelGreen,
                boxColor: Constants.pastelWhite,
                onIncrement: () => {history.addLast("algaeRemove")},
              ),
              Counter(
                ...
                boxColor: Constants.pastelWhite,
                onIncrement: () => {history.addLast("algaePickups")},
              ),
            ],
          ),
          Column(
            children: [
              Counter(
                ...
                boxColor: Constants.pastelWhite,
                onIncrement: () => {history.addLast("coralScoredL4")},
              ),
              Counter(
                ...
                color: Constants.pastelYellow,
                boxColor: Constants.pastelWhite,
                onIncrement: () => {history.addLast("coralScoredL3")},
              ),
              Counter(
                ...
                color: Constants.pastelYellow,
                boxColor: Constants.pastelWhite,
                onIncrement: () => {history.addLast("coralScoredL2")},
              ),
              Counter(
                ...
                color: Constants.pastelYellow,
                boxColor: Constants.pastelWhite,
                onIncrement: () => {history.addLast("coralScoredL1")},
              ),
              Counter(
                ...
                color: Constants.pastelBlue,
                boxColor: Constants.pastelWhite,
                onIncrement: () => {history.addLast("coralPickups")},
              ),
            ],
          )
        ]));
