    ...
    return DefaultContainer(
      ...
      child: Column(
        ...
        children: [
          Text(
            "Team Number:",
            style: TextStyle(fontSize: 18, color: context.colors.containerText),
          ),
          Text(
            "$_currentTeamNumber",
            style: TextStyle(
          ...
          TextField(
            ...
            decoration: InputDecoration(
              ...
              hintStyle: comfortaaBold(17, color: context.colors.hintText),
              hintText: "What's their name?",
              filled: true,
              suffixIcon: _isCorrect
                  ? Icon(Icons.check_circle, color: context.colors.confirm)
                  : null,
          ...
          SizedBox(
            ...
            child: ElevatedButton(
              ...
              style: ElevatedButton.styleFrom(
                elevation: 5,
                shadowColor: context.colors.text,
              ...
              child: Text(
                _isCorrect ? "Correct!" : "Check Answer",
                style: comfortaaBold(17, color: context.colors.container),
              ),
            ),
          ),
        ],
